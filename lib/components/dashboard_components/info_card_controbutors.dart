...
class InfoCardContriButors extends StatefulWidget {
  final List<CompanyData> companies;
  const InfoCardContriButors({
    Key? key,
    required this.companies,
  }) : super(key: key);

  @override
  State<InfoCardContriButors> createState() => _InfoCardContriButorsState();
}

class _InfoCardContriButorsState extends State<InfoCardContriButors> {
  List<CompanyData> activeCompanies = [];
  List<Users> newUsers = [];
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              bottom: 30,
              child: Text(
                activeCompanies.length.toString(),
                style: TextStyle(
                  fontSize: 30,
                  fontWeight: FontWeight.w600,
                  color: kPrimary1,
            ...
            Positioned(
              ...
              bottom: 30,
              child: Text(
                widget.companies.length.toString(),
                style: TextStyle(
                  fontSize: 30,
                  fontWeight: FontWeight.w600,
                  color: kPrimary1,
  ...
  serilaizedData() {
    ...
    setState(() {
      activeCompanies = widget.companies.where((element) => element.active == true).toList();
      //getting everyday count
      day1 = widget.companies.where((element) => element.date! == distinctDate[0]).toList();
      day2 = widget.companies.where((element) => element.date! == distinctDate[1]).toList();
      day3 = widget.companies.where((element) => element.date! == distinctDate[2]).toList();
      day4 = widget.companies.where((element) => element.date! == distinctDate[3]).toList();
      day5 = widget.companies.where((element) => element.date! == distinctDate[4]).toList();
      day6 = widget.companies.where((element) => element.date! == distinctDate[5]).toList();
      day7 = widget.companies.where((element) => element.date! == distinctDate[6]).toList();
